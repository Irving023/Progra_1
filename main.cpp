 ...
 )
{
    ...
    {
        cout << "\n·······································\n";
        cout << ". Oportunidads : " << oportunidades << "\n";
...
)
{
    ...
    for (int i = 0; i < letras_usadas.size(); ++i)
    {
        ...
        {
            cout << "Ya ingresaste esa letra. Intenta ingresar otra.";
